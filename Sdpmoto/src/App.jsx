      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/" element={<HomeLayout />}>
            ...
            <Route path="services/list" element={<ServiceList />} /> {/* Service List route */}
            <Route path="services/search" element={<ServiceSearch />} /> {/* Service Search route */}
            <Route path="price" element={<Price />} />
            <Route path="tutorials" element={<Tutorials />} />
            <Route path="login" element={<Login />} />
            <Route path="register" element={<Register />} />
            <Route path="booking/:service" element={<Booking />} /> {/* New route for booking */}
