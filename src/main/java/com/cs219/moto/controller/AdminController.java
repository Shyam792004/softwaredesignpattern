...
import com.cs219.moto.services.AdminService;
...
public class AdminController {
    ...
    // @PutMapping("/{email}")
    // public ResponseEntity<Admin> updateAdmin(@PathVariable String email,
    // @RequestBody Admin u) {
    // List<Admin> l = as.getByEmail(email);
    // for(Admin existingAdmin : l){
    // if (existingAdmin != null &&
    // existingAdmin.getPassword().equals(u.getPassword())) {
